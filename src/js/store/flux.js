const getState = ({ getStore, getActions, setStore }) => { 
    return {
        ...
        actions: {
            createUser: () => {
                fetch("https://playground.4geeks.com/contact/agendas/nateh1304", {
                    method: "POST",
            ...
            getInfoContacts: () => {
                fetch("https://playground.4geeks.com/contact/agendas/nateh1304/contacts", {
                    method: "GET"
                })
                    .then((response) => {
            ...
            deleteContact: (id) => {
                fetch(`https://playground.4geeks.com/contact/agendas/nateh1304/contacts/${id}`, {
                    method: "DELETE",
                })
                    .then((response) => {
